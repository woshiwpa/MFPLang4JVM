...
if fileInputName.endswith('ATexecution_entry_old.html'):
    title = '@execution_entry Annotation'
elif fileInputName.endswith('citingspace_using_old.html'):
    title = 'citingspace and using citingspace Statements'
...
headTxt = '''<html>
	...
	<body style="background-color:white;">
		<h2 style="color:blue">MFP language Help: '''
...
text-align:justify;text-justify:inter-ideograph;" ><span style="mso-spacerun:'yes';font-family:Garamond;color:rgb(0,0,0);
