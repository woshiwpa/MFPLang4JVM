...
fileInputName = 'tutorial_4_SCP_users_old.html'
fileOutputName = 'tutorial_4_SCP_users.html'
headTxt = '''<html>
	<head>
		<title>Scientific Calculator Plus Help</title>
	</head>
	<body style="background-color:white;">
		<h2 style="color:blue">Tutorial for Scientific Calculator Plus Users</h2>
'''
totalTxt = ''
